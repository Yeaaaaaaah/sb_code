pipeline {
  ...
  environment {
    GITNAME = 'cridom4'
    GITEMAIL = 'curidom4@gmail.com'
    GITWEBADD = 'https://github.com/Yeaaaaaaah/sb_code.git'
    GITSSHADD = 'git@github.com:Yeaaaaaaah/sb_code.git'
    GITDEPADD = 'git@github.com:Yeaaaaaaah/sb_code.git'
  ...
  stages {
    stage('Checkout Github') {
      steps {
        slackSend (channel: '#jenkins_test_pjw', color: '#FFFF00', message: "STARTED: Job '${env.JOB_NAME} [${env.BUILD_NUMBER}]' (${env.BUILD_URL})")
